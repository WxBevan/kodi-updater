...
class ContainerDirectoryCommon(CommonContainerAPIs):
    def __init__(self, handle, paramstring, **kwargs):
        ...
        self.paramstring = paramstring  # plugin://plugin.video.tmdb.bingie.helper?paramstring
    ...
    def context_additions(self):
        if self.context_additions_make_node:
            return [(get_localized(32496), 'RunScript(plugin.video.tmdb.bingie.helper,make_node)')]
        return []

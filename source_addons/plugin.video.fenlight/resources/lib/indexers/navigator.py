...
## ADDED THIS FUNCTION 
	...
	def tools(self):
		self.add({'mode': 'open_accounts', 'isFolder': 'false'}, 'Accounts', 'settings') ## ADDED THIS TOOLS > ACCOUNTS MANAGER
	...
	def maintenance(self):
		...
		self.add({'mode': 'clear_cache', 'cache': 'intros', 'isFolder': 'false'}, 'Clear Intro / Recap / Outro Cache', 'settings')
